...
export const translations = {
  zh: {
    ...
    footer: {
      ...
      motto: '任职于香港中文大学（深圳）数据经济研究院，聚焦金融科技、AI工程化与数据产品建设。',
      quickLinks: '快速导航',
      contactInfo: '联系信息',
      email: '📧 chenggao@cuhk.edu.cn',
      location: '📍 深圳市',
      organization: '🏢 香港中文大学（深圳）数据经济研究院',
      personalSite: '个人生活网站 →',
      copyright: '© {{year}} Gary Chen. Made with',
  ...
  en: {
    ...
    footer: {
      ...
      motto: 'Working at the Institute of Data Economy, CUHK-Shenzhen, focused on fintech, AI engineering, and data products.',
      quickLinks: 'Quick Links',
      contactInfo: 'Contact Info',
      email: '📧 chenggao@cuhk.edu.cn',
      location: '📍 Shenzhen',
      organization: '🏢 Institute of Data Economy, CUHK-Shenzhen',
