  ...
  'data-visualization': [
    {
      ...
      src: ossAsset('/images/portfolio/data-visualization/展示案例-ESG数据获取系统.pdf'),
      type: 'pdf',
      category: '数据可视化'
    },
    {
      ...
      src: ossAsset('/images/portfolio/data-visualization/展示案例-银行理财子费率自动更新系统开发企划书.pdf'),
      type: 'pdf',
      category: '数据可视化'
    }
  ],
  'svg-cards': [
    {
      ...
      src: ossAsset('/images/portfolio/svg-cards/单词卡片示例.png'),
      type: 'image',
      category: 'SVG卡片设计'
    },
    {
      ...
      src: ossAsset('/images/portfolio/svg-cards/读书卡片示例.png'),
      type: 'image',
      category: 'SVG卡片设计'
    },
    {
      ...
      src: ossAsset('/images/portfolio/svg-cards/读书卡片示例2.png'),
      type: 'image',
      category: 'SVG卡片设计'
    },
    {
      ...
      src: ossAsset('/images/portfolio/svg-cards/电影卡片示例.png'),
      type: 'image',
      category: 'SVG卡片设计'
    }
  ],
